        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BinaryPath = table.Column<string>(type: "VARCHAR", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinishAt = table.Column<DateTimeOffset>(nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(nullable: false),
                    CreatedBy = table.Column<string>(nullable: true),
                    Log = table.Column<string>(type: "VARCHAR", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Folders",
                columns: new[] { "Id", "Path" },
                values: new object[] { "2518555347604593271233782980", "/" });
